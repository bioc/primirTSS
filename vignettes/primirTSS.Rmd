...
after scoring can be filter out. Besides, DNase I hypersensitive sites(DHS) also
...
genes in certain cell-line will be considered as well for improve fidelity. By 
...
As Java development environment is indispensable for the main function in our 
...
If one of these to peak data is input, before execute the main function `find_TSS`, 
...
data first, `peak_join` should be employed to integrate H3K4me3 and Pol II peaks
...
* `find_tss` is the main function in the package. The program will first score 
